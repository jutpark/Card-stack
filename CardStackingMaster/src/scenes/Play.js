...
this.ship01 = new Card(this, (game.config.width + borderUISize*10), (borderUISize), 'diamond', 0, 10).setOrigin(0, 0);
this.ship02 = new Card(this, (game.config.width + borderUISize*10), borderUISize*3 + borderPadding*2, 'heart', 0, 10).setOrigin(0,0);
this.ship03 = new Card(this, (game.config.width + borderUISize*10), borderUISize*5 + borderPadding*4, 'club', 0, 10).setOrigin(0,0);
this.ship04 = new Card(this, (game.config.width + borderUISize*10), borderUISize*7 + borderPadding*6, 'diamond', 0, 10).setOrigin(0,0);
this.ship03.scale=1;
this.ship02.scale=1;
this.ship01.scale=1;
